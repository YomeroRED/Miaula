...
const DB = {
  ...
  notas: [
    {
      id: 1,
      titulo: 'Fórmulas de Álgebra Lineal',
      contenido: '- Determinante 2x2: ad - bc\n- Traza: suma de la diagonal principal\n- Transpuesta: filas ↔ columnas',
      etiqueta: 'clase',
      autorId: 2,
      fecha: '2026-03-20',
      fechaMod: '2026-03-20',
    ...
    {
      id: 2,
      titulo: 'Ideas para proyecto final',
      contenido: 'Propuesta: análisis de datos de ventas con regresión lineal. Incluir visualizaciones con gráficas de dispersión.',
      etiqueta: 'proyecto',
      autorId: 2,
      fecha: '2026-03-21',
      fechaMod: '2026-03-22',
    ...
    {
      id: 3,
      titulo: 'Recordatorios semana de exámenes',
      contenido: 'Lunes: Matemáticas III\nMiércoles: Estadística\nViernes: Administración\n\nEstudiar cap. 4 y 5 antes del lunes.',
      etiqueta: 'examen',
      autorId: 2,
      fecha: '2026-03-23',
      fechaMod: '2026-03-23',
    ...
    {
      id: 4,
      titulo: 'Notas de clase — APA 7ma',
      contenido: 'Puntos clave del manual:\n• DOI obligatorio en artículos digitales\n• Apellido, Inicial. (Año). Título. Editorial.\n• Máx. 20 autores antes de usar et al.',
      etiqueta: 'clase',
      autorId: 2,
      fecha: '2026-03-18',
      fechaMod: '2026-03-18',
    ...
    {
      id: 5,
      titulo: 'Plan de estudio parcial',
      contenido: 'Semana 1: repasar apuntes\nSemana 2: ejercicios prácticos\nSemana 3: simulacro de examen',
      etiqueta: 'personal',
      autorId: 1,
      fecha: '2026-03-15',
      fechaMod: '2026-03-15',
  ...
  nextId: { users: 4, tareas: 5, entregas: 3, recursos: 4, notas: 6 },
};
